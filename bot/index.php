...
*/
ob_start();
$API_KEY = '#'; //add your bot token
$bot_ = "Antar_mbot"; // add your bot username 
$sudo = 323823995; // add your id 
...
🇸🇩 من فضلك اختر اللغة المناسبة لك 🇸🇩
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
     ...
     ['text'=>"اضفني الى مجموعتك ♣️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
    	...
    	[
     ['text'=>"مراسلة المطور 🚶", 'url'=>"t.me/AntarSidgi"]
     ],
     [
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
    ...
    ['text'=>"Add me to your Gp ♣️️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
     ...
     [
     ['text'=>"support 💡", 'url'=>"t.me/AntarSidgi"]
     ],
     [
 ...
 'parse_mode'=>'html',
   'reply_markup'=>json_encode([
    ...
    ['text'=>"افزودن من به گروه ♣️️", 'url'=>"https://telegram.me/$bot_?startgroup=start"]
     ...
     [
     ['text'=>"پشتیبانی 💡", 'url'=>"t.me/AntarSidgi"]
     ],
     [
...
if($re  &&  $text == "/del" or $text == "حذف" or $text == "مسح"){
bot('deleteMessage',[
'chat_id'=>$re_chatid,
'message_id'=>$re_msgid
]);
